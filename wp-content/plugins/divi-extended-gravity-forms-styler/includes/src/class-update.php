...
if ( ! class_exists( 'El_Gravity_Forms_Styler_Update' ) ) {
	class El_Gravity_Forms_Styler_Update {
		/**
	     * Plugin Name.
	     *
	     * @since 	 1.0.0
		...
		public function __construct() {
			$this->plugin_name			= 'divi-extended-gravity-forms-styler';
			$this->plugin_version		= ELICUS_GRAVITY_FORMS_STYLER_VERSION;
			$this->plugin_basename		= ELICUS_GRAVITY_FORMS_STYLER_BASENAME;
	        $this->metadata_url 		= 'http://cdn.elicus.com';
	        $this->upgrade_transient    = 'upgrade_gravity_form_styler';
	        $this->last_checked_option  = 'gravity_form_styler_last_checked';
	...
	new El_Gravity_Forms_Styler_Update;
}