...
if ( ! class_exists( 'El_Gravity_Forms_Styler_Installation' ) ) { 
    class El_Gravity_Forms_Styler_Installation {
         ...
         * @var      string
         */
        public static $plugin_name = 'divi-extended-gravity-forms-styler';
         ...
         * @var      string
         */
        public static $plugin_version = ELICUS_GRAVITY_FORMS_STYLER_VERSION;
